...
const flipDownCards = (cardElement1, cardElement2) => {
...
const squareClick = (cardElement, column, row) => {
  ...
  if (cardElement.innerText === board[column][row].name) {
    ...
    // turn this card over
    match += 1;
    scoreBoard.innerText = `score: ${match}`;
    ...
    flipDownCards(firstCardElement, cardElement);
  }
};
...
const initGame = () => {
  ...
  banner('Start the game by clicking on a sqaure!', 5000);
};
